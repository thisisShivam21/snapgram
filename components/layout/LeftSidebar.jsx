...
const LeftSidebar = () => {
  ...
  return (
    <div className="h-screen left-0 top-0 sticky overflow-auto px-10 py-6 flex flex-col gap-6 max-md:hidden 2xl:w-[350px] pr-20 custom-scrollbar">
      <Link href="/">
        <Image src="/assets/logo.png" alt="logo" width={200} height={200} className="w-auto h-auto" priority />
      </Link>
      <div className="flex flex-col gap-2">
        <div className="flex flex-col gap-2 items-center text-light-1">
          <Link href="/">
            <Image
              src="/assets/mithudon2.jpg"
              alt="profile photo"
              width={50}
              height={50}
          ...
          <p className="text-small-bold">Mithu Don</p>
        </div>
        <div className="flex text-light-1 justify-between">
          ...
          <div className="flex flex-col items-center">
            <p className="text-base-bold">500.5k</p>
